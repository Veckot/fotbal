...
--
-- Host: localhost:3306
-- Generation Time: Oct 13, 2025 at 11:08 AM
...
--
-- Table structure for table `fotbal_article`
--

CREATE TABLE `fotbal_article` (
  `id` int NOT NULL,
...
--
-- Table structure for table `fotbal_team`
--

CREATE TABLE `fotbal_team` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `fotbal_team`
--

INSERT INTO `fotbal_team` (`id`, `name`, `logo`, `tm_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
-- Indexes for table `fotbal_article`
--
ALTER TABLE `fotbal_article`
  ADD PRIMARY KEY (`id`),
  ADD KEY `date` (`date`),
  ADD KEY `top` (`top`);

--
-- Indexes for table `fotbal_team`
--
ALTER TABLE `fotbal_team`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `fotbal_article`
--
ALTER TABLE `fotbal_article`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `fotbal_team`
--
ALTER TABLE `fotbal_team`
